...
impl BusinessType {
    pub fn prefix(self) -> &'static str {
        match self {
            ...
            BusinessType::Analytics => "analytics",
            BusinessType::Notification => "notification",
            BusinessType::Feedback => "feedback",
            BusinessType::Bookmark => "bookmark",
            BusinessType::Comment => "comment",
        }
    }
}
